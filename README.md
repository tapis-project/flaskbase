...
The `common.auth` package provides a function, `get_service_tapi_client` which can be used to get
...
Within `__init__.py`:
```
from common.auth import get_service_tapi_client
t = get_service_tapi_client()
```
